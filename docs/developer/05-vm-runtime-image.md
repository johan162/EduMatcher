...
```
./vm/build_multipass_vm.sh --version 0.12.4
```
...
```
./vm/build_multipass_vm.sh --name edumatcher-072 --version 0.12.4 --snapshot
```
...
multipass exec edumatcher-071 -- sudo /tmp/install_edumatcher_runtime.sh --version 0.12.4
```
