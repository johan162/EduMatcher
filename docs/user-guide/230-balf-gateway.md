...
See [Appendix: BALF Protocol Reference](910-app-balf-protocol.md) for exact
...
See [LOGON frame layout](910-app-balf-protocol.md#logon-0x01-client-server) in
...
See [LOGON_ACK frame layout](910-app-balf-protocol.md#logon_ack-0x02-server-client)
...
See the [BALF Protocol Reference](910-app-balf-protocol.md) appendix for exact
...
!!! tip "Reading frame size"
    ...
    loop needs to do.  See [Message reference summary table](910-app-balf-protocol.md#summary-table).
...
See [NEW_ORDER message layout](910-app-balf-protocol.md#new_order-0x10-client-server)
...
See [Price encoding](910-app-balf-protocol.md#price-encoding) in the protocol
reference.
...
See [ORDER_ACK reject codes](910-app-balf-protocol.md#order_ack-0x11-server-client)
...
and field offsets, see the [BALF Protocol Reference](910-app-balf-protocol.md).)
...
See [HEARTBEAT](910-app-balf-protocol.md#heartbeat-0x30-bidirectional) and
...
- [Appendix: BALF Protocol Reference](910-app-balf-protocol.md) — normative
