...
!!! note "Learning objectives"
    ...
    **Prerequisite**: Read [P&L & Clearing](07-pnl-clearing.md) first — this page
...
[P&L & Clearing](07-pnl-clearing.md)). On every `order.fill` it calls
...
!!! warning "Performance sensitivity"
    ...
    [Running the Engine](03-running-the-engine.md) before adopting a fix.
