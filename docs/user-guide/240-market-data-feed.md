...
[Configuration → Which Process Reads What](010-configuration.md#which-process-reads-what).
...
!!! tip "Prefer a ready-made client?"
    [`pm-calf-spy`](241-calf-spy-cli.md) does everything below for you —
...
1. **Use the built-in WebSocket feed.** The [API Gateway](260-api-gateway.md)
