...
See [External Protocols Overview](19-protocol-overview.md) for the full
comparison table.
...
- [Appendix — RALF Protocol](93-app-ralf-protocol.md) — normative wire format and field tables
- [Market Data Feed (CALF)](20-market-data-feed.md) — pre-trade streaming market data
