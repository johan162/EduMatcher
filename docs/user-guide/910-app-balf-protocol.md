...
> operational, tutorial-style guide see [BALF TCP Gateway](230-balf-gateway.md); for
> the gateway's configuration block see
> [Engine Config Specification §6.2](990-app-config-spec.md#62-balf_gateway-pm-balf-gwy).
...
- [BALF TCP Gateway](230-balf-gateway.md) — operational user guide: setup,
