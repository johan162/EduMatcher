...
- [Gateway Commands](08-gateway.md) — interactive command reference for `pm-alf-console`
- [Configuration](01-configuration.md) — `alf_gateway:` section and `gateways.alf` allowlist
- [Processes](10-processes.md#pm-alf-gwy-alf-tcp-gateway) — process topology and ZMQ message tables
- [External Protocols Overview](19-protocol-overview.md) — protocol comparison and selection guide
