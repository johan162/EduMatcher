...
- `depth_levels` sets how many aggregated price levels per side are sent on
  the CALF `DEPTH` channel (see [920-app-calf-protocol.md](920-app-calf-protocol.md))
...
overrides.  See [BALF TCP Gateway](230-balf-gateway.md) for the full
...
[Centralized Log Server](280-log-srv.md) for the operational guide (starting
the server, using `pm-log-cli`) and [LALF Protocol Reference](940-app-lalf-protocol.md)
...
This is the same behavior described in [Risk Controls](120-risk-controls.md)
...
price collars, see [Risk Controls - Price collars vs circuit breakers](120-risk-controls.md#price-collars-vs-circuit-breakers).
