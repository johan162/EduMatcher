...
- [Processes — pm-audit](170-processes.md#pm-audit-event-logger) — startup reference table in the process overview
- [Persistence](180-persistence.md) — which files each process writes and where they live
- [Statistics and Reporting](140-statistics-and-reporting.md) — `pm-stats` and `pm-stats-cli` for structured market data queries
- [P&L & Clearing](130-pnl-clearing.md) — `pm-clearing` and `pm-clearing-cli` for trade settlement
