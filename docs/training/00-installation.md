...
```bash
curl -fsSL https://raw.githubusercontent.com/johan162/EduMatcher/main/deployment/vm/curl_setup_vm.sh | bash -s -- --version 0.26.1
```
...
!!! tip "Security-first variant"
    ...
    bash curl_setup_vm.sh --version 0.26.1
    ```
