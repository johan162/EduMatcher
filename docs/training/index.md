...
| 03 | [The First Trade](../user-guide/040-running-the-exchange.md) | BUY/SELL limit orders, fills, order book basics |
...
| 17 | [Capstone Scenario](../user-guide/040-running-the-exchange.md) | full exchange session combining all major features |
...
| 19 | [Advanced Admin Operations](../user-guide/160-exchange-commands.md) | kick, qcancel, cancel-sym, session overrides, verification patterns |
...
| 21 | [Automation with CommandClient & MM Bot Tuning](../user-guide/160-exchange-commands.md) | Python automation flows, admin orchestration, advanced pm-mm-bot runtime tuning |
| 22 | [RALF Post-Trade Gateway Protocol](../user-guide/250-ralf-gateway.md) | pm-ralf-gwy, RALF handshake/subscriptions, role-based consumers, replay and recovery |
| 23 | [CALF Market-Data Gateway Protocol](../user-guide/240-calf-gateway.md) | pm-md-gwy, CALF handshake/subscriptions, snapshots, replay and recovery |
...
| 25 | [Market Index (pm-index)](../user-guide/150-market-index.md) | Index config, cap-weighted formula, divisor, corporate actions via pm-index-admin-cli, INDEX command, pm-index-cli |
...
| 17 | [Verifying the system is running correctly](../user-guide/040-running-the-exchange.md#verifying-the-system-is-running-correctly), [Process Overview](../user-guide/170-processes.md#process-overview) |
...
| 19 | [ADMIN console (pm-admin)](../user-guide/160-exchange-commands.md#admin-console-pm-admin), [CLI tool (pm-admin-cli)](../user-guide/160-exchange-commands.md#cli-tool-pm-admin-cli) |
