...
| 18 | [Exchange Observer Processes](180-exchange-observer-processes.md) | *Do this early.* See the book, the tape and the audit trail while you trade | [Processes](../user-guide/170-processes.md) |
...
| 25 | [Market Index](250-index.md) | Run an index and apply corporate actions without disturbing its level | [Market Index](../user-guide/150-market-index.md), [Index Admin CLI](../user-guide/152-index-admin-cli.md) |
