...
export const SHORTCUTS: ShortcutRow[] = [
  ...
  { keys: "F3", scope: "Global", action: "Go to the Positions screen" },
  { keys: "F4", scope: "TRADER", action: "Go to the Active Orders blotter" },
  ...
  { keys: "Ctrl+L", scope: "Global", action: "Go to the Watchlist" },
  {
    keys: "Ctrl+Shift+F",
    scope: "Global",
    action: "Go to Positions, where Flatten All lives (always confirms)",
  },
